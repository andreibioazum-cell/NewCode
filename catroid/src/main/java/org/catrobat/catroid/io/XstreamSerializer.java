...
import org.catrobat.catroid.content.bricks.MemsetBrick;import org.catrobat.catroid.content.bricks.LoopEndBrick;
...
import org.catrobat.catroid.content.bricks.PointerSetBrick;import org.catrobat.catroid.content.bricks.ParameterizedBrick;
...
public final class XstreamSerializer {
	...
	private void prepareXstream(Class projectClass, Class sceneClass) {
		...
		xstream.alias("brick", MallocBrick.class);
		xstream.alias("brick", CallocBrick.class);
		xstream.alias("brick", ReallocBrick.class);
		xstream.alias("brick", FreeBrick.class);
		xstream.alias("brick", MemcpyBrick.class);
		xstream.alias("brick", MemsetBrick.class);
		xstream.alias("brick", TypedefBrick.class);
		xstream.alias("brick", CastBrick.class);
		xstream.alias("brick", PointerSetBrick.class);
		xstream.alias("brick", PointerGetBrick.class);
		xstream.alias("brick", ReturnBrick.class);
		xstream.alias("brick", BreakBrick.class);
		xstream.alias("brick", ContinueBrick.class);
		xstream.alias("brick", WhileBrick.class);
		xstream.alias("brick", DoWhileBrick.class);
		xstream.alias("brick", SwitchBrick.class);
		xstream.alias("brick", CaseBrick.class);
		xstream.alias("brick", SwitchEndBrick.class);
		xstream.alias("brick", TernaryBrick.class);
		xstream.alias("brick", IncrementBrick.class);
		xstream.alias("brick", DecrementBrick.class);
		xstream.alias("brick", SizeofBrick.class);
		xstream.alias("brick", StructBrick.class);
		xstream.alias("brick", EnumBrick.class);
		xstream.alias("brick", AssertBrick.class);
		xstream.alias("brick", GotoBrick.class);
		xstream.alias("brick", LabelBrick.class);
