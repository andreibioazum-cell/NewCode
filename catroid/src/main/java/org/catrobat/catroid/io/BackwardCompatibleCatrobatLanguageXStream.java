...
public class BackwardCompatibleCatrobatLanguageXStream extends XStream {
	...
	private void initializeBrickInfoMap() {
		...
		brickInfo = new BrickInfo(MallocBrick.class.getSimpleName());
		brickInfoMap.put("mallocBrick", brickInfo);
		brickInfo = new BrickInfo(CallocBrick.class.getSimpleName());
		brickInfoMap.put("callocBrick", brickInfo);
		brickInfo = new BrickInfo(ReallocBrick.class.getSimpleName());
		brickInfoMap.put("reallocBrick", brickInfo);
		brickInfo = new BrickInfo(FreeBrick.class.getSimpleName());
		brickInfoMap.put("freeBrick", brickInfo);
		brickInfo = new BrickInfo(MemcpyBrick.class.getSimpleName());
		brickInfoMap.put("memcpyBrick", brickInfo);
		brickInfo = new BrickInfo(MemsetBrick.class.getSimpleName());
		brickInfoMap.put("memsetBrick", brickInfo);
		brickInfo = new BrickInfo(TypedefBrick.class.getSimpleName());
		brickInfoMap.put("typedefBrick", brickInfo);
		brickInfo = new BrickInfo(CastBrick.class.getSimpleName());
		brickInfoMap.put("castBrick", brickInfo);
		brickInfo = new BrickInfo(PointerSetBrick.class.getSimpleName());
		brickInfoMap.put("pointerSetBrick", brickInfo);
		brickInfo = new BrickInfo(PointerGetBrick.class.getSimpleName());
		brickInfoMap.put("pointerGetBrick", brickInfo);
		brickInfo = new BrickInfo(ReturnBrick.class.getSimpleName());
		brickInfoMap.put("returnBrick", brickInfo);
		brickInfo = new BrickInfo(BreakBrick.class.getSimpleName());
		brickInfoMap.put("breakBrick", brickInfo);
		brickInfo = new BrickInfo(ContinueBrick.class.getSimpleName());
		brickInfoMap.put("continueBrick", brickInfo);
