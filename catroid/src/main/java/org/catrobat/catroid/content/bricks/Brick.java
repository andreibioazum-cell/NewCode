...
public interface Brick extends Serializable, Cloneable {
	...
	enum BrickField implements FormulaField {
		...
		VARIABLE_CHANGE, LOOK_NEW, LOOK_COPY,
		...
		C_COUNT, C_SIZE, C_POINTER, C_DESTINATION, C_SOURCE, C_VALUE, C_TYPE, C_OFFSET,
		C_NAME, C_BASE_TYPE, C_FIELDS, C_ENUMERATORS, C_LABEL,
		TERNARY_CONDITION, TERNARY_IF_TRUE, TERNARY_IF_FALSE,
		...
		private static final BrickField[] EXPECTS_STRING_VALUE = {
				...
				REPLACE_ITEM_IN_USERLIST_VALUE, C_TYPE, C_NAME, C_BASE_TYPE, C_FIELDS, C_ENUMERATORS, C_LABEL};
