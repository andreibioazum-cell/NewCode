...
public class DoWhileBrick extends FormulaBrick implements CompositeBrick {
	...
	public DoWhileBrick() {
		addAllowedBrickField(BrickField.IF_CONDITION, R.id.brick_c_do_while_edit_text_condition);
	}

	public DoWhileBrick(double condition) {
		this();
		setFormulaWithBrickField(BrickField.IF_CONDITION, new Formula(condition));
	}
	...
	public Brick clone() throws CloneNotSupportedException {
		DoWhileBrick clone = (DoWhileBrick) super.clone();
	...
	public int getViewResource() {
		return R.layout.brick_c_do_while;
	}
	...
	public void addActionToSequence(Sprite sprite, ScriptSequenceAction sequence) {
		...
		sequence.addAction(sprite.getActionFactory().createDoWhileAction(sprite, sequence,
				getFormulaWithBrickField(BrickField.IF_CONDITION), loopSequence));
	}
}
