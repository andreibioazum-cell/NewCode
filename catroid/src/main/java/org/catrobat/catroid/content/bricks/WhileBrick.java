...
public class WhileBrick extends FormulaBrick implements CompositeBrick {
	...
	public WhileBrick() {
		addAllowedBrickField(BrickField.IF_CONDITION, R.id.brick_c_while_edit_text_condition);
	}

	public WhileBrick(double condition) {
		this();
	...
	public Brick clone() throws CloneNotSupportedException {
		WhileBrick clone = (WhileBrick) super.clone();
	...
	public void addActionToSequence(Sprite sprite, ScriptSequenceAction sequence) {
		...
		sequence.addAction(sprite.getActionFactory().createWhileAction(sprite, sequence,
