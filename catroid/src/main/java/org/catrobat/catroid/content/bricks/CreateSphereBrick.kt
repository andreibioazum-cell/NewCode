...
/**
 * Блок «Создать сферу»: генерирует спрайту 3D-образ сферы.
 */
class CreateSphereBrick : CreateShapeBrick {
    ...
    override fun nameStringRes(): Int = R.string.brick_create_sphere
}
